...
public class CircularCounter extends View {
	...
	private void init(TypedArray a) {
		...
		mTextSize = a.getDimension(R.styleable.CircularMeter_tSize,
				getResources().getDimension(R.dimen.v70));
		mTextColor = a
				.getColor(R.styleable.CircularMeter_tColor, mTextColor);

		mMetricSize = a.getDimension(R.styleable.CircularMeter_metricSize,
				getResources().getDimension(R.dimen.v14));
		mMetricText = a.getString(R.styleable.CircularMeter_metricText);
		mMetricPaddingY = getResources().getDimension(R.dimen.v25);

		mRange = a.getInt(R.styleable.CircularMeter_range, 100);

		mOneWidth = getResources().getDimension(R.dimen.v10);
		mTwoWidth = getResources().getDimension(R.dimen.v10);
		mThreeWidth = getResources().getDimension(R.dimen.v10);
