...
public class BottomBarLayout extends LinearLayout implements View.OnClickListener{
    ...
    private void init(Context context) {
        mLinearLayout = (LinearLayout) View.inflate(context, R.layout.bottom_bar_container,null);
    ...
    public void setTabList(List<TabEntity> tabs){
        ...
        for (int i=0;i<tabs.size();i++) {
            View itemView = View.inflate(getContext(), R.layout.bottom_bar_item_tab, null);
            itemView.setId(i);
