...
public class SwitchMultiButton extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeRadius = typedArray.getDimension(R.styleable.SwitchMultiButton_SwitchMultiButtonStrokeRadius, STROKE_RADIUS);
        mStrokeWidth = typedArray.getDimension(R.styleable.SwitchMultiButton_SwitchMultiButtonStrokeWidth, STROKE_WIDTH);
        mTextSize = typedArray.getDimension(R.styleable.SwitchMultiButton_SwitchMultiButtonTextSize, TEXT_SIZE);
        mSelectedColor = typedArray.getColor(R.styleable.SwitchMultiButton_SwitchMultiButtonSelectedColor, SELECTED_COLOR);
        mSelectedTab = typedArray.getInteger(R.styleable.SwitchMultiButton_SwitchMultiButtonSelectedTab, SELECTED_TAB);
        mTypeface = typedArray.getString(R.styleable.SwitchMultiButton_SwitchMultiButtonTypeface);
        int mSwitchTabsResId = typedArray.getResourceId(R.styleable.SwitchMultiButton_SwitchMultiButtonSwitchTabs, 0);
