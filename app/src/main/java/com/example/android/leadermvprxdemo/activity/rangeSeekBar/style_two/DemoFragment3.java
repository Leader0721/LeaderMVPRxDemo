...
public class DemoFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bubbleSeekBar1.getConfigBuilder()
                ...
                .secondTrackColor(ContextCompat.getColor(getContext(), R.color.blue))
                .thumbColor(ContextCompat.getColor(getContext(), R.color.blue))
                .showSectionText()
        ...
        bubbleSeekBar2.getConfigBuilder()
                ...
                .trackColor(ContextCompat.getColor(getContext(), R.color.red_200))
                .secondTrackColor(ContextCompat.getColor(getContext(), R.color.red))
                .seekBySection()
                .showSectionText()
                .sectionTextPosition(BubbleSeekBar.TextPosition.BELOW_SECTION_MARK)
                .build();
        ...
        bubbleSeekBar3.getConfigBuilder()
                ...
                .floatType()
                .sectionCount(10)
                .secondTrackColor(ContextCompat.getColor(getContext(), R.color.green))
                .showSectionText()
                .showThumbText()
                .build();
