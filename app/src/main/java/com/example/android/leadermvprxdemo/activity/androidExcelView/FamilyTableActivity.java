...
import com.example.android.leadermvprxdemo.activity.androidExcelView.lib.adapters.BaseTableAdapter;

import java.util.ArrayList;
import java.util.List;

public class FamilyTableActivity extends Activity {
    ...
    public class FamilyNexusAdapter extends BaseTableAdapter {
        ...
        public FamilyNexusAdapter(Context context) {
            ...
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "1", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "2", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "3", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "4", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "5", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "6", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "7", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "8", "--", "--", "--"));
            familys[2].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "9", "--", "--", "--"));
        }

        @Override
        public int getRowCount() {
            return familys.length + familys[0].list.size() + familys[1].list.size() + familys[2].list.size();
        }
