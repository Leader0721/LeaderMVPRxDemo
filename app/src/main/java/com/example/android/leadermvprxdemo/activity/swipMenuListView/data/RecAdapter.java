package com.example.android.leadermvprxdemo.activity.swipMenuListView.data;
...
import com.example.android.leadermvprxdemo.activity.swipMenuListView.SwipeMenuLayout;
...
public class RecAdapter extends RecyclerView.Adapter<RecAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_swipmenu, null);
