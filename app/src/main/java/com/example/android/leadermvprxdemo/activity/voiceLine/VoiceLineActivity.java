package com.example.android.leadermvprxdemo.activity.voiceLine;
...
/**
 * @Description:根据声音分贝的大小来绘制不同的波段图
 * @Prject:
 * @Package: com.example.android.leadermvprxdemo.activity.voiceLine
 * @author: Leader
 * @date: 2018/1/22   17:09
 * @Copyright: 个人版权所有
 * @Company:bc
 * @version: 1.0.0
 */

public class VoiceLineActivity extends BaseActivity implements Runnable {
