package com.example.android.leadermvprxdemo.activity.luban;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PhotoPicker.builder()
                        ...
                        .start(LubanActivity.this, PhotoPicker.REQUEST_CODE);
            }
        });
    }
...
//                compressWithRx(photos);   这个方法最好单拿出来，要不然直接占用内存过大，而且如果一下子处理的图片不多的话，用不着用这个
            }
        }
    }
