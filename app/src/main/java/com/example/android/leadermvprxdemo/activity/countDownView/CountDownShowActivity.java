package com.example.android.leadermvprxdemo.activity.countDownView;
...
import com.example.android.leadermvprxdemo.activity.countDownView.lib.CountdownView;
import com.example.android.leadermvprxdemo.activity.countDownView.lib.DynamicConfig;
...
public class CountDownShowActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_countdown_show);
...
//            @Override
//            public void onClick(View v) {
//                ColorPicker picker = new ColorPicker(CountDownShowActivity.this);
        ...
        findViewById(R.id.btn_refTimeShow).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isShowDay && !isShowHour && !isShowMinute && !isShowSecond && !isShowMillisecond) {
                    Toast.makeText(CountDownShowActivity.this, "Select at least one item", Toast.LENGTH_LONG).show();
                    return;
                }
                DynamicConfig.Builder dynamicConfigBuilder = new DynamicConfig.Builder();
...
//        });
    ...
    private void handlerCheckBoxSel() {
        ...
        cbDay.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                CountDownShowActivity.this.isShowDay = isChecked;
            }
        });
        cbHour.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                CountDownShowActivity.this.isShowHour = isChecked;
            }
        });
        cbMinute.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                CountDownShowActivity.this.isShowMinute = isChecked;
            }
        });
        cbSecond.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                CountDownShowActivity.this.isShowSecond = isChecked;
                if (!isChecked && CountDownShowActivity.this.isShowMillisecond) {
        ...
        cbMillisecond.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                CountDownShowActivity.this.isShowMillisecond = isChecked;
                if (isChecked && !CountDownShowActivity.this.isShowSecond) {
