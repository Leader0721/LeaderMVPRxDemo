...
public class RadarViewActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    RadarView radarView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radarView = (RadarView) this.findViewById(R.id.radarView);
        // 雷达图各项值比例
...
//        radarView.setDataColor(Color.parseColor("#999900"));
        ...
        // 雷达图标题和图标的点击事件
        radarView.setOnTitleClickListener(new RadarView.OnTitleClickListener() {
            @Override
            public void onTitleClick(RadarView view, int position, int x, int y, Rect rect) {
                Toast.makeText(RadarViewActivity.this, "position = " + position, Toast.LENGTH_SHORT).show();
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RadarViewActivity.this, RadarDemoActivity.class);
