...
public class Wave extends View {
    ...
    private int mWidth = DensityUtils.dip2px(  50);
    private int mHeight = DensityUtils.dip2px(  50);
    private Path path;
    private float currentPercent;
    private int color;
    private String text = "贴";
    private int textSize = DensityUtils.sp2px(  25);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //自定义颜色和文字
        color = array.getColor(R.styleable.Wave_wave_color, Color.rgb(41, 163, 254));
        text = array.getString(R.styleable.Wave_wave_text);
        array.recycle();
        //图形及路径填充画笔
