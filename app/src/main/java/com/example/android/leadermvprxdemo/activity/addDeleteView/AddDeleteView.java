...
public class AddDeleteView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            if (background != null) {
                ...
                setBackgroundResource(R.drawable.bg_adddeletepicker);
            }
    ...
    public AddDeleteView setCurrentNumber(int currentNumber) {
    ...
    public AddDeleteView setInventory(int inventory) {
    ...
    public AddDeleteView setBuyMax(int buyMax) {
        mBuyMax = buyMax;
        return this;
    }

    public AddDeleteView setBuyMin(int buyMin) {
        mBuyMin = buyMin;
        return this;
    }

    public AddDeleteView setOnWarnListener(OnWarnListener onWarnListener) {
    ...
    public AddDeleteView setStep(int step) {
        mStep = step;
        return this;
    }
