...
public class HorizontalExpandMenuView extends RelativeLayout {
    ...
    public HorizontalExpandMenuView(Context context) {
        super(context);
        this.mContext = context;
        init();
    }

    public HorizontalExpandMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        this.mAttrs = attrs;
        init();
    ...
    private void init() {
        TypedArray typedArray = mContext.obtainStyledAttributes(mAttrs, R.styleable.HorizontalExpandMenuView);
        defaultWidth = DensityUtils.dip2px(200);
        defaultHeight = DensityUtils.dip2px(40);

        menuBackColor = typedArray.getColor(R.styleable.HorizontalExpandMenuView_back_color, Color.WHITE);
        menuStrokeSize = typedArray.getDimension(R.styleable.HorizontalExpandMenuView_stroke_size, 1);
        menuStrokeColor = typedArray.getColor(R.styleable.HorizontalExpandMenuView_stroke_color, Color.GRAY);
        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalExpandMenuView_corner_radius, DensityUtils.dip2px(20));

        buttonStyle = typedArray.getInteger(R.styleable.HorizontalExpandMenuView_button_style, Right);
        buttonIconDegrees = 90;
        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalExpandMenuView_button_icon_size, DensityUtils.dip2px(8));
        buttonIconStrokeWidth = typedArray.getDimension(R.styleable.HorizontalExpandMenuView_button_icon_stroke_width, 8);
        buttonIconColor = typedArray.getColor(R.styleable.HorizontalExpandMenuView_button_icon_color, Color.GRAY);

        expandAnimTime = typedArray.getInteger(R.styleable.HorizontalExpandMenuView_expand_time, 400);
        typedArray.recycle();
