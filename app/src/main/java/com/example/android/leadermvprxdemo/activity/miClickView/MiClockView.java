...
public class MiClockView extends View {
    ...
    public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = ta.getColor(R.styleable.MiClockView_miClockBgColor, Color.parseColor("#237EAD"));
        setBackgroundColor(mBackgroundColor);
        mLightColor = ta.getColor(R.styleable.MiClockView_miClockLightColor, Color.parseColor("#ffffff"));
        mDarkColor = ta.getColor(R.styleable.MiClockView_miClockDarkColor, Color.parseColor("#80ffffff"));
        mTextSize = ta.getDimension(R.styleable.MiClockView_miClockTextSize, DensityUtils.sp2px(14));
        ta.recycle();
