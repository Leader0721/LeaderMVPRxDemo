...
import com.example.android.leadermvprxdemo.activity.androidExcelPanelView.bean.Cell;
import com.example.android.leadermvprxdemo.activity.androidExcelPanelView.bean.ColTitle;
import com.example.android.leadermvprxdemo.activity.androidExcelPanelView.bean.RowTitle;
import com.example.android.leadermvprxdemo.activity.androidExcelPanelView.lib.BaseExcelPanelAdapter;
...
public class CustomAdapter extends BaseExcelPanelAdapter<RowTitle, ColTitle, Cell> {
    ...
    public RecyclerView.ViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_room_status_normal, parent, false);
    ...
    public RecyclerView.ViewHolder onCreateTopViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_room_status_top_header, parent, false);
    ...
    public RecyclerView.ViewHolder onCreateLeftViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_room_status_left_header, parent, false);
    ...
    public View onCreateTopLeftView() {
        return LayoutInflater.from(context).inflate(R.layout.item_room_status_normal, null);
    }
}
