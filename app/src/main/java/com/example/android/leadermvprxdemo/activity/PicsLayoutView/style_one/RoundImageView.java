...
public class RoundImageView extends AbsRoundImageView {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.RoundImageRedisView);
            leftTopRadius = ta.getDimension(R.styleable.RoundImageRedisView_leftTopRadius, 0);
            rightTopRadius = ta.getDimension(R.styleable.RoundImageRedisView_rightTopRadius, 0);
            rightBottomRadius = ta.getDimension(R.styleable.RoundImageRedisView_rightBottomRadius, 0);
            leftBottomRadius = ta.getDimension(R.styleable.RoundImageRedisView_leftBottomRadius, 0);
            ta.recycle();
        }
    }
