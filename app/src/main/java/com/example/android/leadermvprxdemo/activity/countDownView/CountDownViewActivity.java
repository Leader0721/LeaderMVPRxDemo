...
public class CountDownViewActivity extends BaseActivity implements CountdownView.OnCountdownEndListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_toDynamicShowActivity).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CountDownViewActivity.this, CountDownShowActivity.class));
            }
        });
        ...
        findViewById(R.id.btn_toListViewActivity).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CountDownViewActivity.this, CountDownList1Activity.class));
            }
        });
    }
