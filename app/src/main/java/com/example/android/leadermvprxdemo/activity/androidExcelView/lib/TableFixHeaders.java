package com.example.android.leadermvprxdemo.activity.androidExcelView.lib;
...
import com.example.android.leadermvprxdemo.activity.androidExcelView.lib.adapters.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
    ...
    public TableFixHeaders(Context context, AttributeSet attrs) {
        ...
        this.shadowSize = getResources().getDimensionPixelSize(R.dimen.v8);
