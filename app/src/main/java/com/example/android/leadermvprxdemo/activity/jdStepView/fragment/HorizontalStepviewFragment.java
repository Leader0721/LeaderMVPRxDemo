package com.example.android.leadermvprxdemo.activity.jdStepView.fragment;
...
import com.example.android.leadermvprxdemo.activity.jdStepView.HorizontalStepView;
...
public class HorizontalStepviewFragment extends Fragment {
    ...
    private void showSetpView0() {
        ...
        setpview0.setStepsViewIndicatorComplectingPosition(2)//设置完成的步数
                ...
                .setStepsViewIndicatorCompleteIcon(ContextCompat.getDrawable(getActivity(), R.mipmap.complted))//设置StepsViewIndicator CompleteIcon
                .setStepsViewIndicatorDefaultIcon(ContextCompat.getDrawable(getActivity(), R.mipmap.default_icon))//设置StepsViewIndicator DefaultIcon
                .setStepsViewIndicatorAttentionIcon(ContextCompat.getDrawable(getActivity(), R.mipmap.attention));//设置StepsViewIndicator AttentionIcon
    }
