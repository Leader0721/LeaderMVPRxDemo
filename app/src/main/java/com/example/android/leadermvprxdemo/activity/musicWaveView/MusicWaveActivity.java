package com.example.android.leadermvprxdemo.activity.musicWaveView;
...
@SuppressLint("NewApi")
public class MusicWaveActivity extends Activity {
    private static final String TAG = "MusicWaveActivity";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_musicwave);
        mLinearLayout = (LinearLayout) findViewById(R.id.ll);
        mMediaPlayer = MediaPlayer.create(this, R.raw.musicwave);
