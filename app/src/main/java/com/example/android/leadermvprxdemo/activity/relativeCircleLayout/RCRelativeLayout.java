...
public class RCRelativeLayout extends RelativeLayout {
    ...
    public RCRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStrokeColor = ta.getColor(R.styleable.RCRelativeLayout_RCStroke_color, Color.WHITE);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.RCRelativeLayout_RCStroke_width, 0);
