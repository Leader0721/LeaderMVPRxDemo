...
public final class SnackbarUtils1 {
     ...
     *
     * @param parent 依赖view
     * @return {@link SnackbarUtils1}
     */
    public static SnackbarUtils1 with(@NonNull final View parent) {
        return new SnackbarUtils1(parent);
    }
     ...
     * @return {@link SnackbarUtils1}
     */
    public SnackbarUtils1 setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return {@link SnackbarUtils1}
     */
    public SnackbarUtils1 setMessageColor(@ColorInt final int color) {
     ...
     * @return {@link SnackbarUtils1}
     */
    public SnackbarUtils1 setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return {@link SnackbarUtils1}
     */
    public SnackbarUtils1 setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return {@link SnackbarUtils1}
     */
    public SnackbarUtils1 setDuration(@Duration final int duration) {
     ...
     * @return {@link SnackbarUtils1}
     */
    public SnackbarUtils1 setAction(@NonNull final CharSequence text, @NonNull final View.OnClickListener listener) {
    ...
    public SnackbarUtils1 setAction(@NonNull final CharSequence text, @ColorInt final int color, @NonNull final View.OnClickListener listener) {
     ...
     */
    public SnackbarUtils1 setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
