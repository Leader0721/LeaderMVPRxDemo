...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final String filePath, final String authority) {
        return getInstallAppIntent(FileUtils2.getFileByPath(filePath), authority);
    }
     ...
     * @return
     */
    public static Intent getSendEmailIntent(String[] receivers, String[] copys, String title, String content) {
        Intent intent = new Intent(Intent.ACTION_SEND);
