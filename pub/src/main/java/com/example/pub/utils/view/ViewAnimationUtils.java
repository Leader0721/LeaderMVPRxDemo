...
public class ViewAnimationUtils {
     ...
     */
    public static void invisibleViewByAlpha(final View view,
                                            long durationMillis, final Animation.AnimationListener animationListener) {
     ...
     */
    public static void invisibleViewByAlpha(final View view,
                                            boolean isBanClick, final Animation.AnimationListener animationListener) {
    ...
    public static void goneViewByAlpha(final View view, long durationMillis,
                                       final boolean isBanClick, final Animation.AnimationListener animationListener) {
    ...
    public static void visibleViewByAlpha(final View view, long durationMillis,
                                          final boolean isBanClick, final Animation.AnimationListener
                                                  animationListener) {
