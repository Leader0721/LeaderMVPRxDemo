package com.example.pub.view.slidedatetimepicker;
...
public class CustomDatePicker extends DatePicker {
    ...
    public CustomDatePicker(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            //边界线,目前为透明
            selectionDividerField.set(monthNumberPicker, getResources().getDrawable(R.drawable.timepicker_divider));
            selectionDividerField.set(dayNumberPicker, getResources().getDrawable(R.drawable.timepicker_divider));
            selectionDividerField.set(yearNumberPicker, getResources().getDrawable(R.drawable.timepicker_divider));
        ...
        for (Field pf : pickerFields) {
            ...
            if (pf.getName().equals("mInputText"))//能找到这个域 （分割线视图)
            {
                try {
                    ...
                    editText.setBackgroundResource(R.mipmap.timepicker_circle_tran);
                } catch (IllegalAccessException e) {
                    e.printStackTrace();
                }
                break;
