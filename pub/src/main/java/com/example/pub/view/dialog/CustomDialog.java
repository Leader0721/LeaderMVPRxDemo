package com.example.pub.view.dialog;
...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CustomDialog create(boolean isCancelable, int positiveBack, int negativeBack) {
            ...
            if (negativeButtonText != null) {
                rightButton = ((Button) layout.findViewById(R.id.negativeButton));
        ...
        public CustomDialog create(boolean isCancelable) {
            return create(isCancelable, true);
        }
        ...
        public CustomDialog create(boolean isCancelable, boolean isPositiveEnable) {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CustomDialog dialog = new CustomDialog(context, R.style.customDialog);
            ...
            if (positiveButtonText != null) {
                ...
                setPositiveButtonEnable(isPositiveEnable);
