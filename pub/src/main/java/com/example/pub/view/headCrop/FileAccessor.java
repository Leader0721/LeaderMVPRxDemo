...
/**
 * 文件操作工具类
 * Created by Leader on 2015/3/17.
 */
public class FileAccessor {

    public static final String APPS_ROOT_DIR = getExternalStorePath() + File.separator + FileUtil.CACHE_PATH;
    public static final String IMESSAGE_IMAGE = getExternalStorePath() + File.separator +  FileUtil.CACHE_PATH + FileUtil.CACHE_IMAGE_PATH;
    ...
    public static String getSmallPicture(String filePathStr) {
        ...
        File smallFile = new File(filePath_Success);
    ...
    public static Bitmap getSmallBitmap(String filePath) {
        ...
        options.inSampleSize = calculateInSampleSize(options, 2048, 1440);
