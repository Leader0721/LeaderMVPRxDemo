...
/**
 * @Description:水波纹效果都额自定义效果
 * @Prject:
 * @Package: cn.bcbook.app.teacher.ui.view
 * @author: Leader
 * @date: 2018/1/16   16:06
 * @Copyright: 个人版权所有
 * @Company:bc
 * @version: 1.0.0
 */
public class MaterialLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_alpha_per, DEFAULT_ALPHA);
