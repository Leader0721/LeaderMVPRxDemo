...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            //边界线,目前为透明
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.drawable.timepicker_divider));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.drawable.timepicker_divider));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.drawable.timepicker_divider));
