...
package com.example.pub.view.filechoose;
...
public class FileLoader extends AsyncTaskLoader<List<File>> {
	...
	public List<File> loadInBackground() {
        ...
        final File[] dirs = pathDir.listFiles(ChooseFileUtils.sDirFilter);
        if (dirs != null) {
            // Sort the folders alphabetically
            Arrays.sort(dirs, ChooseFileUtils.sComparator);
        ...
        final File[] files = pathDir.listFiles(ChooseFileUtils.sFileFilter);
        if (files != null) {
            // Sort the files alphabetically
            Arrays.sort(files, ChooseFileUtils.sComparator);
